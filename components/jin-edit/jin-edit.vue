...
<template>
	<view class="container" :style="{
		...
		<u-field class="title" v-model="titles" type="textarea" :auto-height="true" label-width="100" :field-style="fieldstyle" :trim="true" :clearable="true" label="标题:" label-align="center" clear-size="40" placeholder="请填写标题(不多于24字)" maxlength="24">
		</u-field>
		<u-line color="#98ffd8" margin="20rpx 0 80rpx 0" :hair-line="false"/>
